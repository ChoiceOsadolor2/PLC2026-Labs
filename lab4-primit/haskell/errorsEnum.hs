...
main =
    ...
    putStrLn (show result ++ " results from: " ++ show (results2Error result))
...
results2Error ABitDifferent = FP_Rounding
results2Error Infinity = FP_Overflow
results2Error Zero = FP_Underflow
results2Error VeryDifferent = Int_Overflow
